...
def get_images_labels(data_path, label_path, smri=False):
...
if __name__ == "__main__":
    data_path = "./data/srphs_sh_h"
    label_path = "./data/clinica/participants.tsv"
    smri = True

    images, labels = get_images_labels(data_path, label_path, smri)
    ...
    model_dir = f"model_{label}_{max_epochs}_ep_{curr_time}"
